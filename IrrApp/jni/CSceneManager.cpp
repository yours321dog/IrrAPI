	...
	const core::vector3df& scale, bool alsoAddIfMeshPointerZero)
{
	...
	//__android_log_print(ANDROID_LOG_INFO, "Enron", "CSceneManager:addAnimatedMeshSceneNode()");
	if (!alsoAddIfMeshPointerZero && !mesh)
		return 0;
...
void CSceneManager::drawAll()
{
	...
	*/
	...
	if(ShadowFlag)
	{
		//__android_log_print(ANDROID_LOG_INFO,"Enron","CSceneManager:drawall():render shadows");
		...
		{
			//__android_log_print(ANDROID_LOG_INFO,"Enron","CSceneManager:drawall():render shadows,shadowList size = %d ",ShadowNodeList.size());
...
void CSceneManager::setShadowFlag()
{
