...
{
	//__android_log_print(ANDROID_LOG_INFO,"Enron","CNullDriver:drawStencilShadow()");
}
...
{
	//__android_log_print(ANDROID_LOG_INFO,"Enron","CNullDriver:deleteAllDynamicLights()");
	Lights.set_used(0);
}
...
{
	//__android_log_print(ANDROID_LOG_INFO,"Ernon","CNullDriver:addDynamicLight()"); 
...
{
	//__android_log_print(ANDROID_LOG_INFO,"Enron","CNullDriver:getDynamicLight() with index:%d", idx);

	//__android_log_print(ANDROID_LOG_INFO,"Enron","CNullDriver:getDynamicLight()light pos: %d, %d, %d", 
	//	Lights[idx].Position.X, Lights[idx].Position.Y, Lights[idx].Position.Z);
