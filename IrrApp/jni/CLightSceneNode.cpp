...
{
	//__android_log_print(ANDROID_LOG_INFO,"Enron","CLightSceneNode:CLightSceneNode()");
	#ifdef _DEBUG
...
{
	//__android_log_print(ANDROID_LOG_INFO,"Enron","CLightSceneNode:render()");
...
{
	//__android_log_print(ANDROID_LOG_INFO,"Enron","CLightSceneNode:setVisible()");
...
{
	//__android_log_print(ANDROID_LOG_INFO,"Enron","CLightSceneNode:doLightRecalc()");
