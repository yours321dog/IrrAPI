...
extern "C"
{
	void Java_zte_test_irrlib_Scene_nativeSetClearColor(
		JNIEnv *env, jobject defaultObj, jint r, jint g, jint b, jint a)
	{
		backColor = video::SColor(a,r,g,b);
	}
	
	void Java_zte_test_irrlib_Scene_nativeDrawImage(
	...
	void Java_zte_test_irrlib_Scene_nativeDrawRectangle(
	...
	void Java_zte_test_irrlib_Scene_nativeDrawText(
	...
	void Java_zte_test_irrlib_Scene_nativeSmgrDrawAll(
		JNIEnv *env, jobject defaultObj)
	{
		smgr->drawAll();
	}
	
	void Java_zte_test_irrlib_Scene_nativeSetAmbientLight(
		JNIEnv *env, jobject defaultObj, jint r, jint g, jint b, jint a)
	{
		smgr->setAmbientLight(video::SColor(a,r,g,b));
	}
	
	void Java_zte_test_irrlib_Scene_nativeSetActiveCamera(
	...
	int Java_zte_test_irrlib_Scene_nativeGetTouchedSceneNode(
